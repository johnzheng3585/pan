      ...
      <Grid item xs={12} sm={6} md={4} ref={ref}>
        <SummaryButton
          ...
          sx={{
            ...
            "&:hover": {
              background: (theme) =>
                `${theme.palette.mode === "light" ? "#f8fbff" : theme.palette.action.hover}!important`,
            ...
            <NoWrapBox sx={{ flexGrow: 1, p: 1, pl: 0, pr: 2 }}>
              ...
              >
                ...
                {share && (
                  <Chip
                    size="small"
                    label={share.expired ? t("application:share.expired") : "有效"}
                    color={share.expired ? "default" : "success"}
                    variant={share.expired ? "outlined" : "filled"}
                    sx={{
                      ml: "auto",
                      height: 22,
                      borderRadius: "6px",
