...
import { alpha, AppBar, Box, Collapse, IconButton, Stack, Toolbar, useMediaQuery, useTheme } from "@mui/material";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {!isMobile && isMainPage && (
          <Stack direction={"row"} spacing={1.25} sx={{ height: 42, alignItems: "center", flexGrow: 1, maxWidth: 720 }}>
            <NavBarMainActions />
          </Stack>
        )}
        <Box sx={{ flexGrow: 1 }} />
