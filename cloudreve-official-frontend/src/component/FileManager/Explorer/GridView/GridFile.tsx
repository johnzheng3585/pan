...
const StyledButtonBase = styled(ButtonBase)<{
  ...
  return {
    ...
    alignItems: "stretch",
    overflow: "hidden",
    transition: "background-color 180ms ease,opacity 180ms ease,box-shadow 180ms ease,border-color 180ms ease,transform 180ms ease",
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {isSelected ? (
                <CheckmarkCircle sx={{ width: 22, height: 22 }} color={"primary"} />
              ) : hovered && !isTouch ? (
                <CheckUnchecked sx={{ width: 22, height: 22 }} color={"action"} />
              ) : (
                <FileIcon
                  file={file}
            ...
            {!isEditing && !uploading && fileTag && fileTag.length > 0 && (
              <FileTagSummary sx={{ p: 0, maxWidth: "45%" }} tags={fileTag} />
            )}
            {!isEditing && uploading && <UploadingTag sx={{ p: 0, maxWidth: "45%" }} />}
                  ...
                  <Fade key={"icon"}>
                    <LargeIconContainer>
                      <FileIcon
                        ...
                        iconProps={{
                          sx: {
                            fontSize: `${isMobile ? 30 : 34}px`,
                            height: `${isMobile ? 40 : 44}px`,
                            width: `${isMobile ? 38 : 42}px`,
                          },
                        }}
                        file={file}
                        loading={isLoadingIndicator}
